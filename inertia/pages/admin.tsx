...
export default function Admin() {
  const { fetchProducts, allProducts } = useProducts()
  useEffect(() => {
  ...
  return (
    <>
      <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 m-5 " role="alert">
        <span className="font-medium">Administrativo ainda em desenvolvimento...</span>
      </div>
